...
<h2><span id="title">Worker待处理任务数<b>{$total_jobs}</b> ，计时：<span id="count">3</span>s</span>，<a href="javascript:void(0)" onclick="clearInterval(q)">暂停</a></h2>
</div>
</body></html>
<script>
...
if ($t_info) {
	...
	finishTask($t_info['id'], $status, $task->msg);
}
?>